...
public class HoraPontoPK implements Serializable {
    ...
    public HoraPontoPK(int codigoEmpresa, int matricula, int dia, int mes, int ano, int horaEntrada) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof HoraPontoPK))
			return false;
		final HoraPontoPK other = (HoraPontoPK) obj;
		if (ano != other.ano)
			return false;
